...
class UserInterface(QWidget):
   def __init__(self):
      ...
      self.background2.object.setPixmap(QPixmap("Desktop/BaseSystemModule3/background.png")) if self.os == 'M' else self.background2.object.setPixmap(QPixmap("./background.png"))

      self.title = Text(self, 28, "         BASE SYSTEM         ", 50, 30)
      self.title.setFontSize(18) if self.os == 'W' else False
      ...
      self.logTag.setFontSize(8) if self.os == 'W' else False
      ...
      self.log.setFontSize(10) if self.os == 'W' else False
      self.log.setSize(400, 40)
      self.log.normal()
      
      self.run = Button(self, 20, "RUN", 50, 670)
      self.run.setFontSize(12) if self.os == 'W' else False
      ...
      self.home.setFontSize(12) if self.os == 'W' else False
      ...
      self.speedTag.setFontSize(9) if self.os == 'W' else False
      ...
      self.topSpeedText.setFontSize(9) if self.os == 'W' else False
      ...
      self.goalTag.setFontSize(9) if self.os == 'W' else False
      ...
      self.goalDegree.setFontSize(7) if self.os == 'W' else False
         
      self.goalSingleStationText = Text(self, 15, "SINGLE\nSTATION", 675, 253)
      self.goalSingleStationText.setFontSize(9) if self.os == 'W' else False
      self.goalSingleStationInput = InputBox(self, 18, 700, 298)
      self.goalSingleStationInput.setFontSize(9) if self.os == 'W' else False
      self.goalSingleStationInput.setSize(25, 25)
      self.goalSharp = Text(self, 15, "#", 685, 300)
      self.goalSharp.setFontSize(9) if self.os == 'W' else False

      self.goalMultiStationText = Text(self, 15, "MULTI STATION QUEUE", 552, 370)
      self.goalMultiStationText.setFontSize(9) if self.os == 'W' else False
      ...
      for i in range(3):
         for j in range(5):
            ...
            self.goalMultiStationInput[-1].setFontSize(9) if self.os == 'W' else False
      ...
      self.endEffTag.setFontSize(9) if self.os == 'W' else False
      self.endEffText = Text(self, 16, "STATUS", 530, 605)
      self.endEffText.setStyle("color:white")
      self.endEffText.setFontSize(9) if self.os == 'W' else False
      ...
      self.endEffStatusText.setFontSize(9) if self.os == 'W' else False
      ...
      self.mcuTag.setFontSize(9) if self.os == 'W' else False
      ...
      self.mcuText.setFontSize(9) if self.os == 'W' else False
      self.mcuText.setStyle("color:white")
      self.mcuStatusText = Text(self, 15, "DISCONNECT", 665, 694)
      self.mcuStatusText.setFontSize(9) if self.os == 'W' else False
...
#-----------------------------------------------------------------------------------------------------------------
      ...
      if(msi.replace('.','',1).isdigit()):
         if(float(msi) > 10):
            ...
            self.log.error()
            self.log.setText("MAX SPEED CANNOT BE 0")
            self.maxSpeed = -1
         else:
            self.maxSpeed = msi
      else:
...
#-----------------------------------------------------------------------------------------------------------------
   ...
   def mode_2(self):
      self.ser.write([146,109]) # 10010010 01101101
      self.serialWait()
      if(self.ser.read(2) == b'Xu'):
         print("Connect MCU")

   def mode_3(self):
      self.ser.write([147,108]) # 10010011 01101100
      self.serialWait()
      if(self.ser.read(2) == b'Xu'):
   ...
   def mode_7(self):
      ...
      serialSize = self.goalMultiStationSize-1
      serialStation = self.goalMultiStation[:serialSize].copy()
      serialList.append(serialSize)

      if(serialSize % 2 == 1):
         serialStation.append(0)
         serialSize += 1

      for i in range(0,serialSize,2):
   ...
   def mode_8(self):
      self.ser.write([152,103]) # 10011000 01100111
      self.serialWait()
      if(self.ser.read(2) == b'Xu'):
   ...
   def mode_13(self):
      self.ser.write([157,98]) # 10011101 01100010
      self.serialWait()
      if(self.ser.read(2) == b'Xu'):
         print("Disable End-Effector")

   def mode_14(self):
      self.ser.write([158,97]) # 10011110 01100001
      self.serialWait()
      if(self.ser.read(2) == b'Xu'):
         print("Set Home")
      self.homing = True
